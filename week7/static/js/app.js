...
fetch(`http://127.0.0.1:3000/api/member?username=${username}`) .then((response) => response.json()   )
...
function getUpdateName(){
  let currentUsername=document.querySelector("#username").innerText.split("，")[0].toLowerCase()
